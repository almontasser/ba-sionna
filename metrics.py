...
Classes:
    ...
    - Baselines are in `baselines.py` (e.g., ExhaustiveSearchBaseline)
...
if __name__ == "__main__":
    ...
    # Optional baseline sanity check (brute-force best (tx,rx) pair)
    print("\nTesting exhaustive search baseline...")
    from baselines import ExhaustiveSearchBaseline
    ...
    bf_gains_baseline = compute_beamforming_gain_db(
        small_channels, baseline_results["tx_beams"], baseline_results["rx_beams"]
    )
